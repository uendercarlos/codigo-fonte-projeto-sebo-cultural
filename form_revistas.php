...
<div class="row">
	<div class="col-lg-8 mx-auto">
		...
		<table align="center">
            <form  class="form-contact" method="post" tabindex="1" action="Factory.php?intens=revistas" >
			<legend>Cadastro de Revistas</legend>
			
			<div class="form-group">
                <input name="nome" class="form-control" placeholder="Nome da Revista" type="text" required>
			</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="form-group">
                <input name="volume" class="form-control" placeholder="Volume" type="number" required>
			</div>
				<div class="form-group">
                <textarea name="assuntos" class="form-control"  placeholder="Assuntos Tratados" required></textarea>
			</div>
...
if(isset($_COOKIE['cadastrouu'])){
   echo    "<script>alert('Revista cadastrada com sucesso!');</script>";
}
?>
